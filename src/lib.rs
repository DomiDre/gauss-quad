...
//!
//! `rayon`: enables parallel versions of the `integrate` functions on the quadrature rule structs. Can speed up integration if evaluating the integrand is expensive.
