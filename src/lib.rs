...
//! the [`serde`](https://docs.rs/serde/latest/serde) crate for the quadrature rule structs.
//!
...
//! The [`rayon`](https://docs.rs/rayon/latest/rayon/) crate depends on the standard library, so this also enables the `std` feature.
//!
